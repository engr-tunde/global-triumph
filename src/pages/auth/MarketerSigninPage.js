        ...
        <Row>
          <Col sm={12} lg={6} className="signup-left">
            ...
            <p>
              ...
              <span>Sign in to your Marketer account</span>
            </p>
          </Col>
            ...
            >
              <div className="signup-bx">
                ...
                <div className="signup-option">
                  <span>
                    Don't have a Marketer Account? <Link to="/marketer-signup">Register</Link>
                  </span>
                  <Link to="/marketer-forgot-password">Forgot password?</Link>
                </div>
                <p className="option">
                  Not a Marketer? <Link to="/login">Login as a user instead</Link>
                </p>
              </div>
            </CustomFormik>
          </Col>
